...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Create Portofolio <a href="{{url('porto')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> Back </a></h1>
...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Create Data Portofolio</h3>
